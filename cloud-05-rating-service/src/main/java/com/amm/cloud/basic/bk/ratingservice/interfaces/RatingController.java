...
import com.amm.cloud.basic.bk.ratingservice.application.RatingService;
...
public class RatingController {
    ...
    public List<Rating> findRatingsByBookId(
            @RequestParam(required = false, defaultValue = "0") Long bookId) { if (bookId.equals(0L)) {
    ...
    @PatchMapping("/{ratingId}") public Rating updateRating(
