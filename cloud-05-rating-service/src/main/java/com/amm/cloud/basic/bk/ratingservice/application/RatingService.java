package com.amm.cloud.basic.bk.ratingservice.application;
...
import com.amm.cloud.basic.bk.ratingservice.domain.RatingCacheRepository;
...
public class RatingService {
    ...
    public Rating findRatingById(Long ratingId) {
        return ratingRepository.findById(ratingId).map(rating -> rating)
